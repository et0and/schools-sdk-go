...
// RequestOption is an option for the requests made by the schools API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/schools-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://schools.tom.so/")
}
...
func WithEnvironmentEnvironment1() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://dev.schools.tom.so/")
}
