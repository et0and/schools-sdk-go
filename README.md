...
```go
import (
	"github.com/et0and/schools-sdk-go" // imported as schools
)
```
...
```sh
go get -u 'github.com/et0and/schools-sdk-go@v0.0.2'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/et0and/schools-sdk-go/option).
